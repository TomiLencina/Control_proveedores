...
public class daoUsuario {
    ...
    String tablaProveedores = "create table if not exists proveedores(id_usuario integer, rubro text, proyecto text, cantidad integer,producto text , foreign key(id_usuario) references usuario(id))";
